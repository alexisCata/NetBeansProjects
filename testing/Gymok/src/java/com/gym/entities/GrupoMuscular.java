...
@NamedQueries({
    ...
    @NamedQuery(name = "GrupoMuscular.findByGrupo", query = "SELECT g FROM GrupoMuscular g WHERE g.grupo = :grupo")})
public class GrupoMuscular implements Serializable {
    ...
    private Collection<Ejercicio> ejerciciosCollection;
    ...
    @XmlTransient
    public Collection<Ejercicio> getEjerciciosCollection() {
        return ejerciciosCollection;
    }

    public void setEjerciciosCollection(Collection<Ejercicio> ejerciciosCollection) {
    ...
    public String toString() {
        return "entidades.GrupoMuscular[ id=" + id + " ]";
    }
